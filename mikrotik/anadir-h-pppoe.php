...
if ($API->connect(IP_MIKROTIK, USER, PASS)) {
   ...
   //Captura para registrar en mikrotik
    ...
    $profile = $plan;
    $comentarios = ("Instalado el :".date('Y-m-d H:i:s')." Ubicacion: ".$ubicacion);
    $error = "";
    //validacion para entrar
    if(isset($nombre) || isset($apellido) || isset($celular)|| isset($telefono) || isset($ubicacion) || isset($precio)){
