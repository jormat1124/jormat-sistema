...
$query = "SELECT * FROM gastos where (tipo_gasto = 'socio' and socio = '$nombre') and fecha_gato BETWEEN '$fecha1' and '$fecha2'";
...
<div class="container">
  ...
  <p>Listado de avance de efectivo: <?php echo $nombre ?></p>            
  <table class="table table-striped">
    <thead>
      <tr>
        
        <th>Detalle</th><th>Cantidad</th><th>Fecha</th>
